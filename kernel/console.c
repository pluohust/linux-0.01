...
static void scrdown(void)
{
	__asm__("std\n\t"
		...
		::"a" (0x0720),
		"c" ((bottom-top-1)*80>>1),
		"D" (origin+(80<<1)*bottom-4),
		"S" (origin+(80<<1)*(bottom-1)-4)
		);
}
